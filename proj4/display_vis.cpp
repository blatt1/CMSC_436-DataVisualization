...
void display(void)
{
    ...
    con = driver->connect("tcp://108.28.170.188:3306","vis_user","b@1tim0r3");
    ...
    for (int pid = MINPID; pid <= MAXPID; pid++)
    {
        ...
        for (list<Encounter>::iterator it = enc_list.begin(); it != enc_list.end(); it++)
        {
            ...
            if (enc.get_symp().compare("Behavioral") == 0)
            {
                red   = 51.0f / 255;
                green = 51.0f/ 255;
                blue  = 0.0f / 255;
            ...
            if (enc.get_symp().compare("Cognitive") == 0)
            {
                red   = 51.0f / 255;
                green = 51.0f / 255;
                blue  = 51.0f / 255;
            ...
            if (enc.get_symp().compare("Depression") == 0)
            {
                red   = 51.0f / 255;
                green = 153.0f / 255;
                blue  = 0.0f / 255;
            ...
            if (enc.get_symp().compare("Endocine") == 0)
            {
                red   = 51.0f / 255;
                green = 153.0f / 255;
                blue  = 255.0f / 255;
            ...
            if (enc.get_symp().compare("Headache") == 0)
            {
                red   = 102.0f / 255;
                green = 0.0f / 255;
                blue  = 0.0f / 255;
            ...
            if (enc.get_symp().compare("Neurology") == 0)
            {
                red   = 102.0f / 255;
                green = 0.0f / 255;
                blue  = 51.0f / 255;
            ...
            if (enc.get_symp().compare("PTSD") == 0)
            {
                red   = 102.0f / 255;
                green = 51.0f / 255;
                blue  = 0.0f / 255;
            ...
            if (enc.get_symp().compare("Parkinsonism") == 0)
            {
                red   = 102.0f / 255;
                green = 102.0f / 255;
                blue  = 0.0f / 255;
            ...
            if (enc.get_symp().compare("Seizure") == 0)
            {
                red   = 102.0f / 255;
                green = 102.0f / 255;
                blue  = 51.0f / 255;
            ...
            if (enc.get_symp().compare("Sleep") == 0)
            {
                red   = 102.0f / 255;
                green = 153.0f / 255;
                blue  = 0.0f / 255;
            ...
            if (enc.get_symp().compare("Speech") == 0)
            {
                red   = 102.0f / 255;
                green = 153.0f / 255;
                blue  = 51.0f / 255;
            ...
            if (enc.get_symp().compare("Stress") == 0)
            {
                red   = 153.0f / 255;
                green = 0.0f / 255;
                blue  = 102.0f / 255;
            ...
            if (enc.get_symp().compare("Vcode") == 0)
            {
                red   = 153.0f / 255;
                green = 51.0f / 255;
                blue  = 0.0f / 255;
            ...
            if (enc.get_symp().compare("Vision") == 0)
            {
                red   = 153.0f / 255;
                green = 102.0f / 255;
                blue  = 0.0f / 255;
            ...
            if (enc.get_symp().compare("late") == 0)
            {
                red   = 153.0f / 255;
                green = 153.0f / 255;
                blue  = 0.0f / 255;
